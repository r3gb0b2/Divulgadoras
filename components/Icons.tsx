...
export const TrashIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M16.5 4.478v.227a48.816 48.816 0 013.878.512.75.75 0 11-.49 1.45 47.475 47.475 0 00-7.618-1.12h-.03c-2.6 0-5.132.39-7.618 1.12a.75.75 0 11-.49-1.45 48.816 48.816 0 013.878-.512V4.478c0-1.121.08-2.228.23-3.32a.75.75 0 01.75-.672h6.22c.39 0 .722.29.75.672.15 1.092.23 2.2.23 3.32zM4.75 9.042c.09-.617.18-1.22.27-1.82a49.923 49.923 0 0113.96 0c.09.6.18 1.203.27 1.82.63 4.27 1.129 9.138 1.377 12.652a.75.75 0 01-.75.806H4.122a.75.75 0 01-.75-.806c.248-3.514.748-8.382 1.378-12.652z" clipRule="evenodd" />
);
...
export const UserMinusIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path d="M10.375 2.25a4.125 4.125 0 100 8.25 4.125 4.125 0 000-8.25zM1.5 15.75c0-2.485 4.25-4.5 9.5-4.5s9.5 2.015 9.5 4.5v2.25a.75.75 0 01-.75.75H2.25a.75.75 0 01-.75-.75v-2.25zM21 10.5a.75.75 0 01.75.75v.006a.75.75 0 01-.75.75H16.5a.75.75 0 01-.75-.75v-.005a.75.75 0 01.75-.75H21z" />
);

export const QrCodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M3 4.5a1.5 1.5 0 011.5-1.5h2.25a1.5 1.5 0 011.5 1.5V6.75a1.5 1.5 0 01-1.5 1.5h-2.25A1.5 1.5 0 013 6.75V4.5zM4.5 4.5v2.25h2.25V4.5h-2.25zM3 15.75A1.5 1.5 0 014.5 14.25h2.25a1.5 1.5 0 011.5 1.5V18a1.5 1.5 0 01-1.5 1.5h-2.25A1.5 1.5 0 013 18v-2.25zM4.5 15.75V18h2.25v-2.25h-2.25zM14.25 4.5a1.5 1.5 0 011.5-1.5h2.25a1.5 1.5 0 011.5 1.5V6.75a1.5 1.5 0 01-1.5 1.5h-2.25A1.5 1.5 0 0114.25 6.75V4.5zM15.75 4.5v2.25h2.25V4.5h-2.25zM12.75 10.5a.75.75 0 01.75-.75h8.25a.75.75 0 01.75.75v.75a.75.75 0 01-.75.75h-8.25a.75.75 0 01-.75-.75v-.75zM12.75 14.25a.75.75 0 01.75-.75h8.25a.75.75 0 01.75.75v.75a.75.75 0 01-.75.75h-8.25a.75.75 0 01-.75-.75v-.75zM12.75 18a.75.75 0 01.75-.75h8.25a.75.75 0 01.75.75v.75a.75.75 0 01-.75.75h-8.25a.75.75 0 01-.75-.75v-.75z" clipRule="evenodd" />
);

export const BoldIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M6 4.5a.75.75 0 01.75-.75h5.25a4.5 4.5 0 010 9H12v4.5h2.25a4.5 4.5 0 010 9H6a.75.75 0 01-.75-.75v-21zM12 12h-4.5V5.25H12a3 3 0 010 6.75zm0 10.5a3 3 0 000-6.75H7.5v6.75H12z" clipRule="evenodd" />
);

export const ItalicIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M12.316 3.25a.75.75 0 01.721.544l-3.03 12.41a.75.75 0 01-1.457-.356l3.03-12.41a.75.75 0 01.736-.188z" clipRule="evenodd" />
);

export const UnderlineIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M18 3.75a.75.75 0 01.75.75v6.75a6.75 6.75 0 01-13.5 0v-6.75a.75.75 0 011.5 0v6.75a5.25 5.25 0 0010.5 0v-6.75a.75.75 0 01.75-.75zM3.75 19.5a.75.75 0 01.75-.75h15a.75.75 0 010 1.5h-15a.75.75 0 01-.75-.75z" clipRule="evenodd" />
);
...
export const ListNumberedIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M3.375 3C2.339 3 1.5 3.84 1.5 4.875v.75c0 1.036.84 1.875 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875v-.75C22.5 3.839 21.66 3 20.625 3H3.375zM1.5 12.375c0-1.036.84-1.875 1.875-1.875h17.25c1.035 0 1.875.84 1.875 1.875v.75c0 1.036-.84 1.875-1.875 1.875H3.375c-1.035 0-1.875-.84-1.875-1.875v-.75zm1.875 5.625c-1.035 0-1.875.84-1.875 1.875v.75c0 1.036.84 1.875 1.875 1.875h17.25c1.035 0 1.875-.84 1.875-1.875v-.75c0-1.036-.84-1.875-1.875-1.875H3.375z" clipRule="evenodd" />
);
...
export const FaceSmileIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75-4.365 9.75-9.75 9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-1.091.202-1.492.693a.75.75 0 01-1.166-.936 3.75 3.75 0 016.566 0 .75.75 0 01-1.166.936 1.875 1.875 0 00-1.492-.693c-.531 0-1.039.226-1.25.37a.75.75 0 11-.836-1.244 3.75 3.75 0 012.086-.37zm4.166 4.853a.75.75 0 01-1.082.43 4.501 4.501 0 00-5.92 0 .75.75 0 01-.964-1.154 6.002 6.002 0 017.966 0 .75.75 0 010 1.154.75.75 0 01-.43.43z" clipRule="evenodd" />
);
...
export const UndoIcon: React.FC<React.SVGProps<SVGSVGElement>> = createStrokeIcon(
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" />
);

export const CreditCardIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M2.25 5.25a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3V18.75a3 3 0 0 1-3 3H5.25a3 3 0 0 1-3-3V5.25Zm3 1.5h13.5a1.5 1.5 0 0 1 1.5 1.5v1.5H3.75v-1.5a1.5 1.5 0 0 1 1.5-1.5Zm-1.5 6v6a1.5 1.5 0 0 0 1.5 1.5h13.5a1.5 1.5 0 0 0 1.5-1.5v-6H3.75Z" clipRule="evenodd" />
);

export const MegaphoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M19.5 3.75a.75.75 0 0 1 .75.75v12a.75.75 0 0 1-1.5 0v-12a.75.75 0 0 1 .75-.75ZM3 9.75A2.25 2.25 0 0 1 5.25 7.5h1.322l3.314-3.79a1.5 1.5 0 0 1 1.95-.192l3.914 2.54a.75.75 0 0 1 .35.644v10.596a.75.75 0 0 1-.35.644l-3.914 2.54a1.5 1.5 0 0 1-1.95-.192l-3.314-3.79H5.25A2.25 2.25 0 0 1 3 14.25v-4.5Z" clipRule="evenodd" />
);

export const MapPinIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M11.54 22.351l.07.04.028.016a.75.75 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 001.144-.742 19.58 19.58 0 002.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 00-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 002.682 2.282 16.975 16.975 0 001.145.742zM12 13.5a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
);
...
export const KeyIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M15.75 1.5a6.75 6.75 0 00-6.651 7.906c.067.39-.032.717-.221.906l-6.5 6.499a3 3 0 00-.878 2.121v2.818c0 .414.336.75.75.75h2.818a3 3 0 002.121-.878l.572-.572a3 3 0 00.878-2.121v-1.2a3 3 0 00-.878-2.121l-.366-.366a.75.75 0 01-.032-1.029l1.265-1.265c.262-.262.59-.336.916-.253a6.75 6.75 0 019.604-8.666zM15.75 6a.75.75 0 100-1.5.75.75 0 000 1.5z" clipRule="evenodd" />
);

export const ClipboardDocumentListIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M12 2.25c-2.429 0-4.817.178-7.152.521C2.87 3.061 1.5 4.795 1.5 6.741v6.018c0 1.946 1.37 3.68 3.348 3.97.877.129 1.761.234 2.652.316V21a.75.75 0 001.28.53l3-3a.75.75 0 00-1.06-1.06l-1.72 1.72v-2.115c.39.04.78.077 1.171.112 2.401.219 4.804.073 7.153-.44 1.978-.433 3.348-2.167 3.348-4.113V6.741c0-1.946-1.37-3.68-3.348-3.97A48.545 48.545 0 0012 2.25zm0 13.5a5.25 5.25 0 100-10.5 5.25 5.25 0 000 10.5zm0-9a.75.75 0 01.75.75v2.25H15a.75.75 0 010 1.5h-2.25v2.25a.75.75 0 01-1.5 0v-2.25H9a.75.75 0 010-1.5h2.25V7.5A.75.75 0 0112 6.75z" clipRule="evenodd" />
);

export const DocumentDuplicateIcon: React.FC<React.SVGProps<SVGSVGElement>> = createStrokeIcon(
