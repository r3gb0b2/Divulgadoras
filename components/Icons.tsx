...
export const BuildingOfficeIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M4.5 2.25a.75.75 0 01.75.75v2.25h13.5V3a.75.75 0 01.75-.75h2.25a.75.75 0 01.75.75v18a.75.75 0 01-.75.75h-2.25a.75.75 0 01-.75-.75V18H5.25v2.25a.75.75 0 01-.75.75H2.25a.75.75 0 01-.75-.75V3a.75.75 0 01.75-.75h2.25zM6 6.75v1.5h12v-1.5H6zm0 4.5v1.5h12v-1.5H6zm0 4.5v1.5h12v-1.5H6z" clipRule="evenodd" />
);

export const ClipboardDocumentListIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M9 2.25a.75.75 0 01.75.75v1.5h4.5v-1.5a.75.75 0 01.75-.75h.75a3 3 0 013 3v12.75a3 3 0 01-3 3H7.5a3 3 0 01-3-3V5.25a3 3 0 013-3h.75zm3 3a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-1.5a.75.75 0 01-.75-.75v-.008a.75.75 0 01.75-.75h1.5zM9.75 9.75a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5zM9.75 12.75a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5zM9.75 15.75a.75.75 0 000 1.5h4.5a.75.75 0 000-1.5h-4.5z" clipRule="evenodd" />
);

export const MegaphoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path d="M16.881 4.345A23.112 23.112 0 018.25 6H7.5a5.25 5.25 0 00-.88 10.427 21.593 21.593 0 001.378 3.94c.464 1.004 1.674 1.32 2.582.796l.657-.379c.884-.51 1.12-1.644.693-2.651a22.59 22.59 0 01-1.052-2.558c.333.018.67.028 1.007.028 2.25 0 4.412-.49 6.362-1.368l.459-.198a1.5 1.5 0 00.901-1.386V6.95a1.5 1.5 0 00-.901-1.386l-.459-.198c-.191-.087-.386-.171-.581-.253A19.63 19.63 0 0116.88 4.345z" />
);

export const CreditCardIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path d="M4.5 3.75a3 3 0 00-3 3v10.5a3 3 0 003 3h15a3 3 0 003-3V6.75a3 3 0 00-3-3h-15zM21 8.25v.75H3v-.75h18zm0 3v6.75a1.5 1.5 0 01-1.5 1.5h-15A1.5 1.5 0 013 18V11.25h18z" />
);
...
export const DocumentDuplicateIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M19.5 21a1.5 1.5 0 001.5-1.5V7.5a1.5 1.5 0 00-1.5-1.5h-1.5v-3a1.5 1.5 0 00-1.5-1.5h-9a1.5 1.5 0 00-1.5 1.5v12a1.5 1.5 0 001.5 1.5h1.5v3a1.5 1.5 0 001.5 1.5h9zM9 3h6v12H9V3zm4.5 15v3h9V7.5h-3v9a1.5 1.5 0 01-1.5 1.5h-4.5z" clipRule="evenodd" />
);
...
export const UnderlineIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M6 3.75a.75.75 0 01.75.75v7.5a5.25 5.25 0 0010.5 0v-7.5a.75.75 0 011.5 0v7.5a6.75 6.75 0 01-13.5 0v-7.5a.75.75 0 01.75-.75zM3.75 19.5a.75.75 0 000 1.5h16.5a.75.75 0 000-1.5H3.75z" clipRule="evenodd" />
);
...
export const FaceSmileIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm-2.625 6c-.54 0-.828.419-.936.634a1.96 1.96 0 00-.189.866c0 .298.059.605.189.866.108.215.395.634.936.634.54 0 .828-.419.936-.634.13-.26.189-.568.189-.866 0-.298-.059-.605-.189-.866-.108-.215-.395-.634-.936-.634zm4.314.634c.108-.215.395-.634.936-.634.54 0 .828.419.936.634.13.26.189.568.189.866 0 .298-.059.605-.189.866-.108.215-.395.634-.936.634-.54 0-.828-.419-.936-.634a1.96 1.96 0 01-.189-.866c0-.298.059-.605.189-.866zm-9 6a.75.75 0 01.75-.75h10.5a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H5.25a.75.75 0 01-.75-.75V15z" clipRule="evenodd" />
);

export const RefreshIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path fillRule="evenodd" d="M4.755 10.059a7.5 7.5 0 0112.548-3.364l1.903 1.903h-3.183a.75.75 0 100 1.5h5.5a.75.75 0 00.75-.75v-5.5a.75.75 0 00-1.5 0v3.18l-1.9-1.9A9 9 0 003.206 9.349a.75.75 0 001.549.71zm14.49 3.882a7.5 7.5 0 01-12.548 3.364l-1.903-1.903h3.183a.75.75 0 000-1.5h-5.5a.75.75 0 00-.75.75v5.5a.75.75 0 001.5 0v-3.18l1.9 1.9a9 9 0 0015.794-4.229.75.75 0 00-1.549-.71z" clipRule="evenodd" />
);
...
export const UserMinusIcon: React.FC<React.SVGProps<SVGSVGElement>> = createIcon(
    <path d="M10.348 15.472a6.001 6.001 0 00-8.098-.67 3 3 0 00-.25 4.448l.25.25H21v-2.25a9 9 0 00-10.652-1.778zM16.5 4.5a3 3 0 11-6 0 3 3 0 016 0z" />
);
