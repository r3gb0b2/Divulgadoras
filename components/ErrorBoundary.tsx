...
class ErrorBoundary extends React.Component<Props, State> {
  // FIX: Using a class property to initialize state. This is the modern approach
  // and fixes type errors where `this.state` was not recognized on the component instance.
  state: State = {
    hasError: false,
    error: null,
    errorInfo: null,
