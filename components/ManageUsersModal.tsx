                ...
                <div className="flex flex-col md:flex-row gap-6 flex-grow min-h-0 overflow-y-auto">
                    ...
                    <div className="w-full md:w-2/3 flex-grow overflow-y-auto border border-gray-700 p-4 rounded-lg">
                         ...
                         <div className="space-y-2">
                            {admins.map(admin => (
                                <div key={admin.uid} className="md:flex md:items-center md:justify-between p-3 bg-gray-700/50 rounded-md">
                                    ...
                                    <div className="flex gap-3 justify-end mt-2 md:mt-0 md:justify-start flex-shrink-0">
