...
// FIX: Using constructor for state initialization to ensure `this` context is correctly established, resolving errors where `this.setState` and `this.props` might not be found.
