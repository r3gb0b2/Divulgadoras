...
import { UsersIcon, MapPinIcon, KeyIcon, BuildingOfficeIcon, ClipboardDocumentListIcon, EnvelopeIcon, SparklesIcon, CreditCardIcon, MegaphoneIcon, SearchIcon, ChartBarIcon, WhatsAppIcon, ClockIcon, TrashIcon, CheckCircleIcon, ShieldCheckIcon } from '../components/Icons';
        ...
        <div>
            ...
            <div className="bg-secondary shadow-lg rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Link to="/admin/cleanup" className="group block p-6 bg-gray-700/50 rounded-lg hover:bg-gray-700 transition-all duration-300 border border-red-500/30 hover:border-red-500/50">
                        <div className="flex items-center">
                            <TrashIcon className="w-8 h-8 text-red-500" />
                            <h2 className="ml-4 text-xl font-semibold text-gray-100">Manutenção de Armazenamento</h2>
                        </div>
                        <p className="mt-2 text-gray-400">Limpar prints e mídias antigas para liberar espaço no banco de dados.</p>
                         <div className="text-sm text-red-400 mt-4 opacity-0 group-hover:opacity-100 transition-opacity font-semibold">Acessar &rarr;</div>
                    </Link>
                    ...
                    <Link to="/admin/settings/privacy" className="group block p-6 bg-gray-700/50 rounded-lg hover:bg-gray-700 transition-all duration-300">
                        <div className="flex items-center">
                            <ShieldCheckIcon className="w-8 h-8 text-primary" />
                            <h2 className="ml-4 text-xl font-semibold text-gray-100">Política de Privacidade</h2>
                        </div>
                        <p className="mt-2 text-gray-400">Editar o texto da política de privacidade do aplicativo.</p>
                        <div className="text-sm text-primary mt-4 opacity-0 group-hover:opacity-100 transition-opacity font-semibold">Editar &rarr;</div>
                    </Link>
