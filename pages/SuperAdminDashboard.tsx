            ...
            <div className="bg-secondary shadow-lg rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Link to="/admin/whatsapp-reminders" className="group block p-6 bg-gray-700/50 rounded-lg hover:bg-gray-700 transition-all duration-300">
                        ...
                        <p className="mt-2 text-gray-400">Monitore e envie lembretes automáticos de postagem pendentes.</p>
                         <div className="text-sm text-primary mt-4 opacity-0 group-hover:opacity-100 transition-opacity font-semibold">Gerenciar &rarr;</div>
                    </Link>
