        ...
        return (
            <div className="mt-8">
                ...
                <div className="space-y-6">
                    ...
                    {activeTab === 'history' && (historyAssignments.length > 0 ? historyAssignments.map(a => <PostCard key={a.id} assignment={a} onConfirm={()=>{}} onJustify={handleOpenJustification} onReminderRequested={()=>{}} />) : <p className="text-center text-gray-400 py-8 border border-dashed border-gray-700 rounded-lg">Seu histórico está vazio.</p>)}
                </div>
            </div>
        );
    };
