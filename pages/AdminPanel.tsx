...
import { CogIcon, UsersIcon, WhatsAppIcon, InstagramIcon, TikTokIcon, BuildingOfficeIcon, LogoutIcon, ArrowLeftIcon, CheckCircleIcon, XIcon, TrashIcon, FaceIdIcon } from '../components/Icons';
...
export const AdminPanel: React.FC<AdminPanelProps> = ({ adminData }) => {
    ...
    // Fix for error on line 509: Explicitly type searchInput and finalEmail to ensure they are strings before calling findPromotersByEmail.
