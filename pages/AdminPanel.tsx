...
import { CogIcon, WhatsAppIcon, InstagramIcon, TikTokIcon, CheckCircleIcon, XIcon, TrashIcon, SearchIcon, RefreshIcon, FilterIcon } from '../components/Icons';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ adminData }) => {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            setPromoters(fetchedPromoters.sort((a, b) => {
        ...
        <div className="space-y-6">
            ...
            <div className="bg-secondary p-4 rounded-xl border border-gray-800 flex flex-col md:flex-row gap-4">
                <div className="flex-grow relative">
                    ...
                    <input 
                        type="text" 
                        placeholder="Filtrar nesta lista por nome ou @..." 
                        value={searchQuery}
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-800">
                            {isLoading ? (
                                ...
                                <tr><td colSpan={5} className="text-center py-20 text-gray-500">Nenhum cadastro encontrado.</td></tr>
