                            ...
                            <div className="grid gap-6">
                                {isLoading ? (
                                    <div className="py-20 flex flex-col items-center gap-4">
                                        ...
                                        <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Sincronizando Ofertas...</p>
                                    </div>
                                ) : events.map(ev => {
                                        ...
                                        >
                                            <div className="text-left min-w-0 flex-grow pr-4">
                                                ...
                                                <p className="text-[10px] text-gray-500 font-black uppercase mt-1 truncate">
                                                    {isSoldOut ? 'Lote Esgotado' : isLowStock ? 'Últimas Vagas!' : 'Adesão Online'}
                                                </p>
                                            </div>
                                ...
                                {events.length === 0 && !isLoading && <p className="text-center text-gray-500 font-black uppercase text-xs py-10">Nenhuma oferta cadastrada.</p>}
                            </div>
                        </div>
                    )}
