...
import { ArrowLeftIcon, WhatsAppIcon, RefreshIcon, CheckCircleIcon, KeyIcon, LinkIcon } from '../components/Icons';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <form onSubmit={handleSave} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input 
                                    ...
                                    required
                                />
                                <p className="text-[9px] text-gray-600 font-bold uppercase ml-1 italic">* Use a URL base fornecida pelo seu painel Sure.</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        type="password" 
                                        placeholder="Seu Bearer Token ou API Key"
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-gray-500 uppercase ml-1">ID da Instância (Opcional)</label>
                                    <input 
                                        type="text" 
                                        placeholder="Instância Ativa"
                            ...
                            <div className="pt-4 border-t border-white/5">
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-xs font-black text-white uppercase tracking-tight group-hover:text-primary transition-colors">Ativar Integração Sure</span>
                                        <span className="text-[9px] text-gray-500 font-bold uppercase">Quando ativado, o sistema usará esta API para disparos automáticos.</span>
                                    </div>
                                </label>
                            </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-dark/40 p-6 rounded-[2rem] border border-white/5 shadow-xl">
                        <h3 className="text-xs font-black text-primary uppercase tracking-widest mb-4">Informações de Apoio</h3>
                        <div className="space-y-4">
                            <div className="p-4 bg-gray-800/50 rounded-2xl border border-white/5">
                                <p className="text-[10px] text-gray-400 leading-relaxed">
                                    Esta API baseada em Azure (Sure) permite o envio de mensagens, mídias e botões via WhatsApp.
                                </p>
                            </div>
                            <div className="p-4 bg-gray-800/50 rounded-2xl border border-white/5">
                                <p className="text-[9px] font-black text-white uppercase mb-1">Dica de Segurança:</p>
                                <p className="text-[10px] text-gray-400 leading-relaxed italic">
                                    Nunca compartilhe seu API Token. Ele dá acesso total ao envio de mensagens em nome da sua marca.
                                </p>
                            </div>
                        </div>
                    </div>
